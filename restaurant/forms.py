...
from .models import Category, DiningTable, Menu, Reservation, Restaurant, Review
...
class ReservationCreateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["time_start"].widget = forms.Select(choices=Reservation.TIMES)
...
class RestaurantCreateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["description"].widget.attrs[
            "rows"
        ] = "10"  # Specify the number of rows for the textarea
        self.fields["description"].widget.attrs[
            "placeholder"
        ] = "店舗の詳細を記入してください"  # Optional placeholder text  #   self.fields['visit_date'].widget.attrs['class'] = 'form-control'
        self.fields["business_time"].widget.attrs[
            "placeholder"
        ] = "例：9:30～22:00"  # Optional placeholder text  #   self.fields['visit_date'].widget.attrs['class'] = 'form-control'
        self.fields["close_day_of_week"].widget.attrs[
            "placeholder"
        ] = "例：「火、水」、「不定休」"  # Optional placeholder text  #   self.fields['visit_date'].widget.attrs['class'] = 'form-control'
...
class MenuCreateForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["name"].widget.attrs[
            "placeholder"
        ] = "例：〇〇定食、〇〇コース"  # Optional placeholder text  #   self.fields['visit_date'].widget.attrs['class'] = 'form-control'
        self.fields["description"].widget.attrs[
            "placeholder"
        ] = "例：当店おススメのメニューです。ごゆっくりお召し上がりください。"  # Optional placeholder text  #   self.fields['visit_date'].widget.attrs['class'] = 'form-control'
        self.fields["price"].widget.attrs[
            "placeholder"
        ] = "例：800"  # Optional placeholder text  #   self.fields['visit_date'].widget.attrs['class'] = 'form-control'
        self.fields["available_from"].widget = forms.TimeInput(
            format="%H:%M",
            attrs={
                "class": "form-control",  # Add Bootstrap or custom class if needed
...
class CategoryUpdateForm3(forms.ModelForm):
    class Meta:
        model = Category
        fields = "__all__"
