...
class Restaurant(models.Model):
  """レストランモデル"""
  shop_owner = models.ForeignKey(CustomUser, verbose_name='店舗オーナー', on_delete=models.SET_NULL, null=True, blank=True)
  ...
  rate_star = models.FloatField(verbose_name='レートスター', default=0.0, null=True, blank=True)
...
class DiningTable(models.Model):
  ...
  restaurant = models.ForeignKey(Restaurant, verbose_name='レストラン', on_delete=models.SET_NULL, null=True, blank=True)
...
class Menu(models.Model):
  """メニュー（お食事）モデル"""
  restaurant = models.ForeignKey(Restaurant, on_delete=models.SET_NULL, null=True, blank=True) # レストランとの紐づけ
...
class Reservation(models.Model):
  ...
  customer = models.ForeignKey(CustomUser, verbose_name='ユーザー会員', on_delete=models.SET_NULL, null=True, blank=True)
  restaurant = models.ForeignKey(Restaurant, verbose_name='レストラン', on_delete=models.SET_NULL, null=True, blank=True)
