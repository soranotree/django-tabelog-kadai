...
urlpatterns = [
  ...
  path('restaurant/<int:pk>/review-list-2/', views.ReviewListView2.as_view(), name='review_list_2'),
  path('restaurant/<int:restaurant_id>/review-update-2/<int:pk>/edit/', views.ReviewUpdateView2.as_view(), name='review_update2'),
  ...
  path('restaurant/review-list-3/', views.ReviewListView3.as_view(), name='review_list_3'),
  path('category/category-list-3/', views.CategoryListView3.as_view(), name='category_list_3'),
